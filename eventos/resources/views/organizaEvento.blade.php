...
<div class="container">
	<form class="form-horizontal">
      <fieldset>
	      ...
	      <div class="col-lg-10">
	        <input type="text" class="form-control" id="inputEmail" placeholder="Nombre del evento">
	      </div>
          </div>
	      <div class="form-group">
		      	<label for="inputPassword" class="col-lg-2 control-label">Lugar</label>
		        <div class="col-lg-10">
		        	<input type="password" class="form-control" id="inputPassword" placeholder="Lugar">
		        </div>
	   	  </div>
	      <div class="form-group">
		     	<label for="inputDate" class="col-lg-2 control-label">Fecha</label>
		          <div class="col-lg-10">
